...
$(document).on('pageinit', '#LoginPage', function () {
  ...
  /////////////////////////////////////////////////////////////////////////////////////
    ...
    //activate_buttons_footer("", "", "", 1, 2, 0, 1);
		...
		setTimeout(function() { $('#user_txt').focus()},100);
		//$('#pass_txt').val("test");
/*
   ...
   $("#InCodigoEan").keyup(function( event ) { //MARCA
         ...
         $('#searchText').keyup( function(event){
            ...
            console.log("ESTAMOS DENTRO DE PEDIDOS" );
                ...
                logic:"or",
                filters: [
                       { field: 'cod_pedid', operator: "contains", value: textSerch },
                       { field: 'cod_centr', operator: "contains", value: textSerch },
                       { field: 'cod_proveedo', operator: "contains", value: textSerch },
                       { field: 'cod_zona', operator: "contains", value: textSerch }
              ]
              };
            ...
            console.log("VALOR DEL FILTRO DETALLE "+ textSerch);
                ...
                logic:"or",
                filters: [
                       { field: 'cod_articulo', operator: "contains", value: textSerch },
                       { field: 'nom_articulo', operator: "contains", value: textSerch },
                       { field: 'cant_pedida', operator: "contains", value: textSerch },
                       { field: 'cadena_logistica', operator: "contains", value: textSerch },
                       { field: 'unidades_total', operator: "contains", value: textSerch }
              ]
              };
    ...
    $('#searchText').keyup(function (event) {
        ...
        if (localStorage["pantalla"] == "emitidos") {
            ...
            var gridDet = $("#pGridArticulos").data("kendoGrid");
