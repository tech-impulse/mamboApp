        ...
        transaction.executeSql(sql, undefined,
            function (transaction, result) {
                ...
                for (var i = 0; i < result.rows.length; i++) {
					...
					if (rowDb.referencia == undefined || rowDb.referencia == "undefined" ) { ref="";  }
					if (rowDb.quantity == undefined || rowDb.quantity == "undefined" ) { cantidad="";  }
                ...
                $("#pGridArticulos").kendoGrid({
                    ...
                    columns: [{
                        ...
                        headerTemplate: "<div style='position: relative; float: left'><a onclick='pOrdenacionArticulos(\"pGridArticulos\",\"cod_articulo\",\"ordenacionArticulos1\",\"integer\")' data-role='button' role='button'> " 
                                         + nume + " <img id='ordenacionArticulos1' src='./images/sort_both.png' > </a>  </div> ",
                        width: '10%'
                    }, {
                        field: "referencia",
                        title: ref,
