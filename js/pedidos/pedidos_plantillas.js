...
function pMostrarPlantillasFiltradas() {
	...
	db.transaction (function (transaction) 
	{
		...
		var sql = "SELECT o.*, p.name as centro, v.name as proveedor FROM ordersTemplates as o, vendors as v , purchaseCenters as p WHERE o.idVendor=v.idVendor AND o.idPurchaseCenter=p.idPurchaseCenter AND o.idVendor="+provider+" AND o.idPurchaseCenter="+center+" ";
          	 ...
          	 grid.destroy();		
			  	...
			  	localStorage["pedidos_pag_act"]=1;
		            ...
		            columns: [{
		                ...
		                field: "nombre", 
		                headerTemplate: "<div style='position: relative; float: left'><a onclick='pOrdenacionGridPedidosPlan(\"nombre\",\"string\",\"sortPedidosPlant1\")' data-role='button' role='button'> " 
		                                    + localStorage["str_nombre"]+ "<img id='sortPedidosPlant1' src='./images/sort_both.png' > </a></div>",
		                filterable: false,
		                title: nombre,
		                width: '26%'
		            }, {
		                field: "fecha_doc",
		                headerTemplate: "<div style='position: relative; float: left'> <a onclick='pOrdenacionGridPedidosPlan(\"fecha_doc\",\"date\",\"sortPedidosPlant2\",\"dd-MM-yyyy  HH:mm\")' data-role='button' role='button'> " 
		                                    + emit + "<img id='sortPedidosPlant2' src='./images/sort_both.png' > </a></div>",
		                title: emit,
      ...
      if (result.rows.length)
      {
        ...
        for (var i = 0; i < result.rows.length; i++) 
        {
         ...
         if (rowDb.tmp=="1") {
		       ...
		       + " WHERE d.idItem=i.idItem AND d.idInternalOrder='"+rowDb.idTemplate+"' ";
         } else { 
          
	         //Listado de articulos
		       var sqlItem = " SELECT * "
		       + " FROM ordersTemplatesDetail as d   " 
		       + " WHERE d.idTemplate='"+rowDb.idTemplate+"' ";
					}
                            ...
                            cadena_error: rowDb.logisticsChainStatus
                  			...
                  			n_reg=n_reg+1;      			
					            ...
					            columns: [{
					                ...
					                "<a onclick='sortPlanDet(\"pGridNuevoPedidoPlantilla\",\"cod_articulo\",\"string\",\"sortNuevoPedidosPlan1\")' data-role='button' role='button'> " 
		                                 + cod + " <img id='sortNuevoPedidosPlan1' src='./images/sort_both.png' > </a> ", 
				                  title: cod,
				                  ...
				                  filterable: false,
					                ...
					                field: "nom_articulo",
					                headerTemplate: "<div style='position: relative; float: left'>"+
					                "<a onclick='sortPlanDet(\"pGridNuevoPedidoPlantilla\",\"nom_articulo\",\"string\",\"sortNuevoPedidosPlan2\")' data-role='button' role='button'> " 
		                                 + des + " <img id='sortNuevoPedidosPlan2' src='./images/sort_both.png' > </a> ", 
				                  title: des,
				                  filterable: false,
					                width: '50%'
					            }, 
					             {
					                field: "cant_pedida",
					                headerTemplate: "<div style='position: relative; float: left'>"+
					                "<a onclick='sortPlanDet(\"pGridNuevoPedidoPlantilla\",\"cant_pedida\",\"string\",\"sortNuevoPedidosPlan3\")' data-role='button' role='button'> " 
		                                 + cant + " <img id='sortNuevoPedidosPlan3' src='./images/sort_both.png' > </a> ", 
				                  title: cant,
				                  ...
				                  filterable: false,
					                ...
					                headerTemplate: "<div style='position: relative; float: left'>"+
					                "<a onclick='sortPlanDet(\"pGridNuevoPedidoPlantilla\",\"nom_articulo\",\"string\",\"sortNuevoPedidosPlan4\")' data-role='button' role='button'> " 
		                                 + cade + " <img id='sortNuevoPedidosPlan4' src='./images/sort_both.png' > </a> ", 
				                  title: cade,
				                  filterable: false,
					                width: '16%'
					            },{
					                ...
					                headerTemplate: "<div style='position: relative; float: left'>"+
					                "<a onclick='sortPlanDet(\"pGridNuevoPedidoPlantilla\",\"unidades_total\",\"string\",\"sortNuevoPedidosPlan5\")' data-role='button' role='button'> " 
		                                 + unid + " <img id='sortNuevoPedidosPlan5' src='./images/sort_both.png' > </a> ", 
				                  title: unid,
			  	...
			  	localStorage["pedidos_pag_act"]=1;
		            ...
		            columns: [{
		               ...
		               field: "cod_centr",
		                ...
		                headerTemplate: "<div style='position: relative; float: left'><a onclick='sortPlanFecha()' data-role='button' role='button'> " 
		                                + "Fecha" + "<img id='sortPedidosPlan3' src='./images/sort_both.png'></a></div>",
		                width: '12%'
		            },{
		                field: "nombre",
		                filterable:false,
		                headerTemplate: "<div style='position: relative; float: left'><a onclick='sortPlanNombre()' data-role='button' role='button'> " 
		                                +"Nombre"+ " <img id='sortPedidosPlan4' src='./images/sort_both.png' > </a></div>", 
		                width: '17%'
		            },{
		                field: "estado",
		                filterable:false,
		                headerTemplate: "<div style='position: relative; float: left'><a  data-role='button' role='button'> " 
		                                +"Estado"+ " <img id='sortPedidosPlan6' src='./images/sort_both.png' > </a></div>", 
...
function pPopUpFiltroColumnaPlan(Grid, nomColum, tipo, tituloColumna) {
    ...
    switch (tipo) {
        ...
        for (var i = 0; i < datFiltrados.length; i++) {
            ...
            if (filters != null && pComprobarColumnaFiltrada( nomColum )  ) {    a.setAttribute("onClick", "pLimpiarFiltroPlan('" + Grid + "','" + nomColum + "')"); 											 }
            else 									{		 a.setAttribute("onClick", "pFiltroPersoPlan('" + Grid + "' , '" + nomColum + "',null,'" + nombre + "')"); }
